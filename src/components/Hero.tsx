    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <span 
            className="inline-block px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium tracking-wide fade-in" 
          ...
          <h1 
            className="text-4xl md:text-6xl font-bold leading-tight fade-in" 
          ...
          <p 
            className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto fade-in" 
